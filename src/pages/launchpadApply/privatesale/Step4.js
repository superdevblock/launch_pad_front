    ...
    return (
        <div className={`tab-pane ${value.step === 4 ? 'active' : ''}`} role="tabpanel" id="step4">
                    ...
                    {/* {value.audit === true &&
                        <div className="col-6 mt-4 mb-0">
                            <div className="form-group">
                                ...
                                <input className="form-control" onChange={(e) => onChangeInput(e)} value={value.auditlink} type="text" name="auditlink" placeholder="e.g. https://github.com/interfinetwork/smart-contract-audits/blob/audit-updates/OceansFinance_0x7769d930BC6B087f960C5D21e34A4449576cf22a.pdf" />
                            </div>
                        </div>
                    }
            ...
            <ul className="list-inline text-center">
                <li><button type="button" className="btn default-btn prev-step mr-4" onClick={(e) => btnPrevStep(e)}>Back</button></li>
                <li><button type="button" className="btn default-btn next-step" onClick={(e) => btnNextStepValidation(e)}>Continue</button></li>
            </ul>
        </div>
    )
}
