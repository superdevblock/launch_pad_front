...
import { useEthPrice, usePadStatus } from "./helper/useStats";
      ...
      <section id='home' className='project-area pt-0'>
        <div className='container px-2 px-sm-5 py-5'>
          <div className='text-center mt-5'>
            <h2 className='text-white'>The launchpad you deserve is here!</h2>
          ...
          <div className='row my-5'>
            <div className='col-12 col-md-6 col-xl-3'>
              <div className='card text-center my-2 pt-0 pb-4'>
                <h3>
                  ${Number((stats.totalLiquidityRaised * ethPrice).toFixed(4))}
                </h3>
            ...
            <div className='col-12 col-md-6 col-xl-3'>
              <div className='card text-center my-2 pt-0 pb-4'>
                <h3>
                  ${Number((stats.totalValueLocked * ethPrice).toFixed(4))}
                </h3>
          ...
          <div className='d-flex flex-column justify-content-center align-items-center mt-5 text-center'>
            ...
            <h5 className='col-12 col-md-10 text-center color-primary'>
          ...
          <div className='row my-5'>
            <div className='col-12 col-md-6 col-xl-3'>
              <div className='card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4'>
                ...
                <p className=''>
                  Create standard tokens on Ethereum by BDAI token factory.
                </p>
              </div>
            </div>
            <div className='col-12 col-md-6 col-xl-3'>
            ...
            <div className='col-12 col-md-6 col-xl-3'>
              <div className='card d-flex flex-column justify-content-center align-items-center text-center my-2 pt-4 pb-4'>
                ...
                <p>
                  Lock your liquidity to Uniswap after presale as long as you
                  want.
                </p>
              </div>
            </div>
